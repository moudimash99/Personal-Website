export const profile = {
  ...
  cvUrl: "/cv.pdf",
  introLines: [
    "Systems-minded software and cloud engineer specializing in highly-regulated data pipelines and resilient cloud architectures. I translate complex operational requirements into fluid, automated realities.",
    "Driven by the philosophy that elegant systems outlast complex ones."
  ],
}
