        ...
        <Container>
          ...
          <section id="projects" className="scroll-mt-28 space-y-10 mt-16">
            ...
            <div className="pt-6 flex justify-center">
              <Button href="#contact">Go to Contact <ArrowRight className="ml-2 h-4 w-4" /></Button>
            </div>
          </section>
          ...
          <section id="contact" className="scroll-mt-28 mt-16">
            ...
            <div className="mt-4 grid md:grid-cols-3 gap-5">
              <Panel>
                <div className="p-5">
                  <h3 className="text-lg font-semibold pb-2 font-display">Direct</h3>
              ...
              <Panel>
                <div className="p-5">
                  <h3 className="text-lg font-semibold pb-2 font-display">Links</h3>
                  <div className="text-sm space-y-2">
              ...
              <Panel>
                <div className="p-5">
                  <h3 className="text-lg font-semibold pb-2 font-display">Quick Contact</h3>
                  <a href="mailto:machaka.mohammad@gmail.com?subject=Hello%20Mohammad%20—%20Mission%20Debrief">
                    <Button className="w-full">Email Me <Mail className="ml-2 h-4 w-4" /></Button>
                  </a>
                </div>
              </Panel>
            </div>
